...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:activity/f:detail">
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/hiv-cbs/StructureDefinition/art-regimen-switched-or-substituded']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/hiv-cbs/StructureDefinition/art-regimen-switched-or-substituded': maximum cardinality of 'extension' is 1</sch:assert>
