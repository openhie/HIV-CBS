...
Usage: #example
Title: "Absolute CD4 Count and CD4 Percentage Example"
Description:  "Absolute CD4 Count and CD4 percentage Example"
* status = #final
...
* effectiveDateTime =  "2022-12-10"  
* valueInteger  = 650
* component.code = $SCT#313938009
* component.valueQuantity.value = 45.23
